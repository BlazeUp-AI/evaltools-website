...
const FONT_DISPLAY$2 = "'Playfair Display', Georgia, serif";
const FONT_BODY$2 = "'Outfit', 'Helvetica Neue', sans-serif";
const FONT_MONO$5 = "'JetBrains Mono', 'Fira Code', monospace";
const palette = {
  bg: "var(--bg)",
  bgAlt: "var(--bg-alt)",
  surface: "var(--surface)",
...
function Navbar() {
  ...
  return /* @__PURE__ */ jsxs("nav", { style: { ...S.nav, borderColor: scrolled ? "#1e2130" : "transparent" }, children: [
    /* @__PURE__ */ jsx("a", { href: "#hero", onClick: smoothScroll, style: { ...S.logo, textDecoration: "none", cursor: "pointer" }, children: /* @__PURE__ */ jsx("span", { style: { fontWeight: 600, letterSpacing: "0.10em", fontSize: 50 }, children: "Observal" }) }),
    /* @__PURE__ */ jsxs("div", { style: S.navLinks, children: [
      /* @__PURE__ */ jsx("a", { style: S.navLink, href: "#pillars", onClick: smoothScroll, children: "Platform" }),
      /* @__PURE__ */ jsx("a", { style: S.navLink, href: "#proof", onClick: smoothScroll, children: "Why Us" }),
      /* @__PURE__ */ jsx("a", { style: S.navLink, href: "#integration", onClick: smoothScroll, children: "Docs" }),
      /* @__PURE__ */ jsx("a", { style: S.navLink, href: "#privacy", onClick: smoothScroll, children: "Security" }),
      /* @__PURE__ */ jsx("button", { style: S.navCta, onMouseEnter: handleNavHoverIn, onMouseLeave: handleNavHoverOut, children: "Get Started" })
    ] })
  ] });
}
function Footer() {
  return /* @__PURE__ */ jsxs("footer", { style: { ...S.section, padding: "clamp(32px, 6vw, 60px) clamp(16px, 4vw, 32px) clamp(24px, 4vw, 40px)", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 20 }, children: [
    /* @__PURE__ */ jsxs("div", { style: S.logo, children: [
      /* @__PURE__ */ jsxs("svg", { width: "20", height: "20", viewBox: "0 0 26 26", fill: "none", children: [
        /* @__PURE__ */ jsx("circle", { cx: "13", cy: "13", r: "5", fill: palette.accent, opacity: "0.9" }),
        /* @__PURE__ */ jsx("circle", { cx: "5", cy: "8", r: "2.5", fill: palette.accent, opacity: "0.3" }),
        /* @__PURE__ */ jsx("circle", { cx: "21", cy: "8", r: "2.5", fill: palette.accent, opacity: "0.3" }),
        /* @__PURE__ */ jsx("circle", { cx: "5", cy: "18", r: "2.5", fill: palette.accent, opacity: "0.3" }),
        /* @__PURE__ */ jsx("circle", { cx: "21", cy: "18", r: "2.5", fill: palette.accent, opacity: "0.3" })
      ] }),
      /* @__PURE__ */ jsx("span", { style: { fontSize: "1.1rem" }, children: "Observal" })
    ] }),
    /* @__PURE__ */ jsx("div", { style: { fontSize: "0.78rem", color: palette.textMuted }, children: "© 2026 Observal, Inc. · Privacy · Terms · SOC 2 Compliant" })
  ] });
}
...
function Reveal({ children, delay = 0, className = "" }) {
  const [ref2, visible] = useInView(0.12);
  return /* @__PURE__ */ jsx(
    "div",
    {
      ref: ref2,
...
function Orb({ top, left, size = 500, color = palette.accentGlow }) {
...
var _config = {
  ...
  overwrite: false,
  delay: 0
}, _suppressOverwrites$1, _reverting$2, _context$2, _bigNum$1 = 1e8, _tinyNum = 1 / _bigNum$1, _2PI = Math.PI * 2, _HALF_PI = _2PI / 4, _gsID = 0, _sqrt$1 = Math.sqrt, _cos$1 = Math.cos, _sin$1 = Math.sin, _isString$2 = function _isString(value) {
...
}, _replaceRandom = function _replaceRandom2(s2) {
  ...
  var a = !v ? _colorLookup.black : _isNumber$2(v) ? [v >> 16, v >> 8 & _255, v & _255] : 0, r, g, b, h, s2, l, max, min, d, wasHSL;
  if (!a) {
    if (v.substr(-1) === ",") {
 ...
 * @author: Jack Doyle, jack@greensock.com
*/
var _win$3, _doc$3, _docElement$1, _pluginInitted, _tempDiv, _recentSetterPlugin, _reverting$1, _windowExists$1 = function _windowExists2() {
  return typeof window !== "undefined";
...
function HeroAnimation() {
  ...
  const leftTerminal = useRef(null);
  const terminalCmd = useRef(null);
  const publishLine = useRef(null);
  const publishDot = useRef(null);
  const centerHub = useRef(null);
  const mcpCount = useRef(null);
  const newMcpBadge = useRef(null);
  const rightAgents = useRef(null);
  const agentLines = useRef([]);
  const trafficDots = useRef([]);
  const logEntries = useRef([]);
  const addAgentLine = (el) => {
    if (el && !agentLines.current.includes(el)) agentLines.current.push(el);
  };
  const addTrafficDot = (el) => {
    if (el && !trafficDots.current.includes(el)) trafficDots.current.push(el);
  };
  const addLogEntry = (el) => {
    if (el && !logEntries.current.includes(el)) logEntries.current.push(el);
  };
  useGSAP(() => {
    const tl = gsapWithCSS.timeline({ repeat: -1 });
    tl.set([leftTerminal.current, centerHub.current, rightAgents.current], { opacity: 0, y: 15 }).set(terminalCmd.current, { width: 0 }).set(publishLine.current, { scaleY: 0, transformOrigin: "top center" }).set(publishDot.current, { opacity: 0, top: "0%" }).set(newMcpBadge.current, { opacity: 0, scale: 0.8, x: -10 }).set(agentLines.current, { scaleX: 0, transformOrigin: "left center" }).set(trafficDots.current, { opacity: 0, left: "100%" }).set(logEntries.current, { opacity: 0, x: -10 }).set(mcpCount.current, { innerText: "12" });
    tl.to(leftTerminal.current, { opacity: 1, y: 0, duration: 0.6, ease: "power2.out" }).to(terminalCmd.current, { width: "100%", duration: 1.2, ease: "steps(20)" });
    tl.to(centerHub.current, { opacity: 1, y: 0, duration: 0.6, ease: "back.out(1.2)" }, "+=0.2");
    tl.to(publishLine.current, { scaleY: 1, duration: 0.6, ease: "power2.inOut" }, "-=0.2").fromTo(
      publishDot.current,
      { opacity: 0, top: "0%" },
      { opacity: 1, top: "100%", duration: 0.8, ease: "power1.inOut" },
      "<"
    ).to(publishDot.current, { opacity: 0, duration: 0.1 });
    tl.to(mcpCount.current, { innerText: "13", duration: 0.2, snap: "innerText" }).to(newMcpBadge.current, { opacity: 1, scale: 1, x: 0, duration: 0.4, ease: "back.out(2)" }).to(centerHub.current, { boxShadow: "0 0 30px rgba(122, 245, 202, 0.1)", duration: 0.4 });
    tl.to(rightAgents.current, { opacity: 1, y: 0, duration: 0.6, ease: "power2.out" }, "+=0.3").to(agentLines.current, { scaleX: 1, duration: 0.6, stagger: 0.1, ease: "power2.inOut" }, "-=0.3").fromTo(
      trafficDots.current,
      { opacity: 0, left: "100%" },
    ...
    tl.to({}, { duration: 4 }).to([leftTerminal.current, centerHub.current, rightAgents.current, agentLines.current, publishLine.current], {
      opacity: 0,
      y: -10,
      duration: 0.8,
      ease: "power2.inOut"
  ...
  return /* @__PURE__ */ jsx("div", { ref: scaleWrap, style: {
    ...
    justifyContent: "center",
    alignItems: "center"
  }, children: /* @__PURE__ */ jsxs("div", { ref: container, style: s$1.container, children: [
    /* @__PURE__ */ jsx("style", { children: `
            .cursor-blink { animation: blink 1s step-end infinite; }
            @keyframes blink { 50% { opacity: 0; } }
          ` }),
    /* @__PURE__ */ jsxs("div", { style: s$1.trackContainer, children: [
      /* @__PURE__ */ jsxs("div", { style: { ...s$1.trackBase, left: 280, right: 220, width: "auto", top: "calc(50% - 40px)" }, children: [
        /* @__PURE__ */ jsx("div", { ref: addAgentLine, style: { ...s$1.trackLine, background: "rgba(122,245,202,0.6)", boxShadow: "0 0 10px rgba(122,245,202,0.3)" } }),
        /* @__PURE__ */ jsx("div", { ref: addTrafficDot, style: { ...s$1.trafficDot, background: "#7af5ca", boxShadow: "0 0 10px #7af5ca" } })
      ] }),
      /* @__PURE__ */ jsxs("div", { style: { ...s$1.trackBase, left: 280, right: 220, width: "auto", top: "calc(50% + 40px)" }, children: [
        /* @__PURE__ */ jsx("div", { ref: addAgentLine, style: { ...s$1.trackLine, background: "rgba(245,200,122,0.6)", boxShadow: "0 0 10px rgba(245,200,122,0.3)" } }),
        /* @__PURE__ */ jsx("div", { ref: addTrafficDot, style: { ...s$1.trafficDot, background: "#f5c87a", boxShadow: "0 0 10px #f5c87a" } })
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { style: s$1.mainLayout, children: [
      /* @__PURE__ */ jsxs("div", { style: s$1.hubColumn, children: [
        /* @__PURE__ */ jsxs("div", { ref: leftTerminal, style: s$1.terminal, children: [
          /* @__PURE__ */ jsx("div", { style: s$1.termLabel, children: "Platform Eng" }),
          /* @__PURE__ */ jsxs("div", { style: { display: "flex", gap: 6, marginBottom: 10 }, children: [
            /* @__PURE__ */ jsx("div", { style: s$1.termDot }),
            /* @__PURE__ */ jsx("div", { style: s$1.termDot })
          ] }),
          /* @__PURE__ */ jsxs("div", { style: s$1.termBody, children: [
            /* @__PURE__ */ jsx("span", { style: { color: "#8b8fa6" }, children: "~/observal-cli" }),
            /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", marginTop: 6 }, children: [
              /* @__PURE__ */ jsx("span", { style: { color: "rgba(122,245,202,0.8)", marginRight: 8, flexShrink: 0 }, children: "❯" }),
              /* @__PURE__ */ jsxs("div", { ref: terminalCmd, style: { overflow: "hidden", whiteSpace: "nowrap", display: "inline-flex", alignItems: "center" }, children: [
                /* @__PURE__ */ jsx("span", { style: { color: "#e4e5eb" }, children: "mcp register db-core" }),
                /* @__PURE__ */ jsx("span", { className: "cursor-blink", style: { display: "inline-block", width: 6, height: 14, background: "rgba(228,229,235,0.8)", marginLeft: 2, flexShrink: 0 } })
              ] })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { style: s$1.connectorWrap, children: [
          /* @__PURE__ */ jsx("div", { ref: publishLine, style: s$1.connectorLine }),
          /* @__PURE__ */ jsx("div", { ref: publishDot, style: s$1.connectorDot })
        ] }),
        /* @__PURE__ */ jsxs("div", { ref: centerHub, style: s$1.hub, children: [
          /* @__PURE__ */ jsxs("div", { style: s$1.hubHeader, children: [
            /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: 10 }, children: [
              /* @__PURE__ */ jsx("div", { style: s$1.hubIcon, children: /* @__PURE__ */ jsx("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: /* @__PURE__ */ jsx("path", { d: "M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" }) }) }),
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("h3", { style: { color: "#e4e5eb", fontWeight: 700, fontSize: 13, margin: 0 }, children: "Observal Hub" }),
                /* @__PURE__ */ jsx("p", { style: { fontSize: 9, color: "#8b8fa6", letterSpacing: "0.05em", marginTop: 2 }, children: "CENTRAL REGISTRY" })
              ] })
            ] }),
            /* @__PURE__ */ jsx("div", { style: { textAlign: "right" }, children: /* @__PURE__ */ jsxs("div", { style: { fontSize: 18, fontWeight: 700, color: "#e4e5eb", lineHeight: 1, display: "flex", alignItems: "center", justifyContent: "flex-end", gap: 6 }, children: [
              /* @__PURE__ */ jsx("span", { ref: mcpCount, children: "12" }),
              /* @__PURE__ */ jsx("span", { style: { fontSize: 9, color: "#8b8fa6", fontWeight: 400, marginTop: 3 }, children: "MCPs" })
            ] }) })
          ] }),
          /* @__PURE__ */ jsxs("div", { style: s$1.mcpList, children: [
            /* @__PURE__ */ jsx("span", { style: s$1.mcpChip, children: "stripe-mcp" }),
            /* @__PURE__ */ jsx("span", { style: s$1.mcpChip, children: "git-mcp" }),
            /* @__PURE__ */ jsx("span", { ref: newMcpBadge, style: s$1.mcpChipNew, children: "db-core ✓" })
          ] }),
          /* @__PURE__ */ jsxs("div", { style: s$1.telemetry, children: [
            /* @__PURE__ */ jsxs("div", { style: s$1.telemetryHeader, children: [
              /* @__PURE__ */ jsx("span", { children: "Live Telemetry" }),
              /* @__PURE__ */ jsxs("span", { style: { display: "flex", alignItems: "center", gap: 4 }, children: [
                /* @__PURE__ */ jsx("div", { style: { width: 5, height: 5, borderRadius: "50%", background: "#7af5ca" } }),
                " Rec"
              ] })
            ] }),
            /* @__PURE__ */ jsxs("div", { style: s$1.logArea, children: [
              /* @__PURE__ */ jsx("div", { style: s$1.logTimeline }),
              /* @__PURE__ */ jsxs("div", { ref: addLogEntry, style: s$1.logRow, children: [
                /* @__PURE__ */ jsx("div", { style: { ...s$1.logDot, background: "#8b8fa6" } }),
                /* @__PURE__ */ jsx("span", { style: s$1.logTime, children: "14:02" }),
                /* @__PURE__ */ jsx("span", { style: { color: "#e4e5eb" }, children: "Health check: db-core" })
              ] }),
              /* @__PURE__ */ jsxs("div", { ref: addLogEntry, style: s$1.logRow, children: [
                /* @__PURE__ */ jsx("div", { style: { ...s$1.logDot, background: "#7af5ca", boxShadow: "0 0 5px #7af5ca" } }),
                /* @__PURE__ */ jsx("span", { style: s$1.logTime, children: "14:03" }),
                /* @__PURE__ */ jsxs("span", { children: [
                  /* @__PURE__ */ jsx("span", { style: { color: "#e4e5eb" }, children: "CodeBot" }),
                  " → ",
                  /* @__PURE__ */ jsx("span", { style: { color: "#7af5ca" }, children: "git-mcp" })
                ] })
              ] }),
              /* @__PURE__ */ jsxs("div", { ref: addLogEntry, style: s$1.logRow, children: [
                /* @__PURE__ */ jsx("div", { style: { ...s$1.logDot, background: "#f5c87a", boxShadow: "0 0 5px #f5c87a" } }),
                /* @__PURE__ */ jsx("span", { style: s$1.logTime, children: "14:03" }),
                /* @__PURE__ */ jsxs("span", { children: [
                  /* @__PURE__ */ jsx("span", { style: { color: "#e4e5eb" }, children: "SalesBot" }),
                  " → ",
                  /* @__PURE__ */ jsx("span", { style: { color: "#f5c87a" }, children: "stripe-mcp" })
                ] })
              ] }),
              /* @__PURE__ */ jsxs("div", { ref: addLogEntry, style: { ...s$1.logRow, marginTop: 2 }, children: [
                /* @__PURE__ */ jsx("span", { style: { width: 40 } }),
                /* @__PURE__ */ jsx("span", { style: s$1.warnBadge, children: "⚠ Rate Limit" })
              ] })
            ] })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsx("div", { style: s$1.agentColumn, children: /* @__PURE__ */ jsxs("div", { ref: rightAgents, style: { display: "flex", flexDirection: "column", gap: 14 }, children: [
        /* @__PURE__ */ jsx("div", { style: s$1.agentLabel, children: "AI Agent Fleet" }),
        /* @__PURE__ */ jsxs("div", { style: s$1.agentCard, children: [
          /* @__PURE__ */ jsx("div", { style: { ...s$1.agentStripe, background: "rgba(122,245,202,0.5)" } }),
          /* @__PURE__ */ jsxs("div", { style: s$1.agentHeader, children: [
            /* @__PURE__ */ jsx("span", { style: { fontSize: 12, fontWeight: 700, color: "#e4e5eb" }, children: "CodeBot Agent" }),
            /* @__PURE__ */ jsx("span", { style: s$1.agentVersion, children: "v2.4" })
          ] }),
          /* @__PURE__ */ jsxs("div", { style: s$1.agentBody, children: [
            /* @__PURE__ */ jsxs("div", { children: [
              "Using: ",
              /* @__PURE__ */ jsx("span", { style: { color: "#7af5ca" }, children: "git-mcp" })
            ] }),
            /* @__PURE__ */ jsxs("div", { children: [
              "Status: ",
              /* @__PURE__ */ jsx("span", { style: { color: "#e4e5eb" }, children: "Processing..." })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { style: s$1.agentCard, children: [
          /* @__PURE__ */ jsx("div", { style: { ...s$1.agentStripe, background: "rgba(245,200,122,0.5)" } }),
          /* @__PURE__ */ jsxs("div", { style: s$1.agentHeader, children: [
            /* @__PURE__ */ jsx("span", { style: { fontSize: 12, fontWeight: 700, color: "#e4e5eb" }, children: "SalesBot Agent" }),
            /* @__PURE__ */ jsx("span", { style: s$1.agentVersion, children: "v1.1" })
          ] }),
          /* @__PURE__ */ jsxs("div", { style: s$1.agentBody, children: [
            /* @__PURE__ */ jsxs("div", { children: [
              "Using: ",
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              "Status: ",
              /* @__PURE__ */ jsx("span", { style: { color: "#f5c87a" }, children: "Rate limited" })
            ] })
          ] })
        ] })
      ] }) })
...
const handleHoverIn$1 = (e) => {
  e.target.style.transform = "scale(1.03)";
};
const handleHoverOut$1 = (e) => {
  e.target.style.transform = "scale(1)";
};
function Hero() {
  return /* @__PURE__ */ jsxs(
    "section",
    {
      ...
      id: "hero",
      children: [
        /* @__PURE__ */ jsx(Orb, { top: "-20%", left: "-10%", size: 700 }),
        /* @__PURE__ */ jsx(Orb, { top: "30%", left: "60%", size: 400, color: "rgba(122,200,245,0.12)" }),
        /* @__PURE__ */ jsxs("div", { style: { flex: "1 1 300px", zIndex: 10 }, children: [
          /* @__PURE__ */ jsx(Reveal, { delay: 0.08, children: /* @__PURE__ */ jsxs("h1", { style: S.heroH1, children: [
            "Stop AI failures before they reach",
            " ",
            /* @__PURE__ */ jsx("span", { style: { color: palette.accent, fontStyle: "italic" }, children: "production" })
          ] }) }),
          /* @__PURE__ */ jsx(Reveal, { delay: 0.16, children: /* @__PURE__ */ jsx("p", { style: S.heroSub, children: "Multi-judge evaluation and guardrails for every AI tool you ship. Plug in, get a verdict, deploy with confidence." }) }),
          /* @__PURE__ */ jsx(Reveal, { delay: 0.24, children: /* @__PURE__ */ jsxs("div", { style: S.heroCtas, children: [
            /* @__PURE__ */ jsx("button", { style: S.btnPrimary, onMouseEnter: handleHoverIn$1, onMouseLeave: handleHoverOut$1, children: "Evaluate Your First AI Tool →" }),
            /* @__PURE__ */ jsx("button", { style: S.btnGhost, children: "Read the Docs" })
          ] }) })
        ] }),
        /* @__PURE__ */ jsx("div", { style: {
          ...
          zIndex: 10,
          minHeight: 580
        }, children: /* @__PURE__ */ jsx(Reveal, { delay: 0.4, children: /* @__PURE__ */ jsx(HeroAnimation, {}) }) })
      ]
    }
  );
}
...
function Pillars() {
  return /* @__PURE__ */ jsxs("section", { style: S.section, id: "pillars", children: [
    /* @__PURE__ */ jsx(Reveal, { children: /* @__PURE__ */ jsxs("div", { style: { textAlign: "center" }, children: [
      /* @__PURE__ */ jsx("div", { style: S.sectionTag, children: "How It Works" }),
      /* @__PURE__ */ jsx("h2", { style: { ...S.sectionH2, margin: "0 auto 12px", textAlign: "center" }, children: "Three pillars. One airtight evaluation pipeline." }),
      /* @__PURE__ */ jsx("p", { style: { ...S.sectionSub, margin: "0 auto", textAlign: "center" }, children: "Built for the environments where standard evaluators fail: massive codebases, tangled dependencies, zero room for error." })
    ] }) }),
    /* @__PURE__ */ jsx("div", { style: S.pillarsGrid, children: pillars.map((p, i) => /* @__PURE__ */ jsx(Reveal, { delay: i * 0.1, children: /* @__PURE__ */ jsxs(
      "div",
      {
        style: S.pillarCard,
        onMouseEnter: (e) => {
        ...
        children: [
          /* @__PURE__ */ jsx(
            "div",
            {
              style: { position: "absolute", top: 0, left: 0, right: 0, height: 2, background: p.accent, opacity: 0, transition: "opacity 0.3s" },
              className: "pillar-stripe"
            }
          ),
          /* @__PURE__ */ jsx("div", { style: S.pillarNum, children: p.num }),
          /* @__PURE__ */ jsx("h3", { style: S.pillarH3, children: p.title }),
          /* @__PURE__ */ jsx("p", { style: S.pillarP, children: p.body })
        ]
      }
    ) }, i)) })
  ] });
 ...
 * @author: Jack Doyle, jack@greensock.com
*/
var gsap$2, _coreInitted$1, _win$2, _doc$2, _docEl$1, _body$2, _isTouch, _pointerType, ScrollTrigger$1, _root$1, _normalizer$1, _eventTypes, _context$1, _getGSAP$2 = function _getGSAP() {
  ...
  sc: _scrollCacheFunc(function(value) {
    return arguments.length ? _win$2.scrollTo(value, _vertical.sc()) : _win$2.pageXOffset || _doc$2[_scrollLeft] || _docEl$1[_scrollLeft] || _body$2[_scrollLeft] || 0;
  })
}, _vertical = {
  s: _scrollTop,
  p: "top",
  ...
  op: _horizontal,
  sc: _scrollCacheFunc(function(value) {
    return arguments.length ? _win$2.scrollTo(_horizontal.sc(), value) : _win$2.pageYOffset || _doc$2[_scrollTop] || _docEl$1[_scrollTop] || _body$2[_scrollTop] || 0;
  })
  ...
  var prev = _scrollers[i + offset], func = prev || (_scrollers[i + offset] = _scrollCacheFunc(_getProxyProp(element, s2), true) || (_isViewport$1(element) ? sc : _scrollCacheFunc(function(value) {
  ...
  if (!_coreInitted$1 && gsap$2 && typeof document !== "undefined" && document.body) {
    ...
    _body$2 = _doc$2.body;
    _root$1 = [_win$2, _doc$2, _docEl$1, _body$2];
    gsap$2.utils.clamp;
...
var gsap$1, _coreInitted, _win$1, _doc$1, _docEl, _body$1, _root, _resizeDelay, _toArray$1, _clamp2, _time2, _syncInterval, _refreshing, _pointerIsDown, _transformProp$1, _i, _prevWidth, _prevHeight, _autoRefresh, _sort, _suppressOverwrites, _ignoreResize, _normalizer, _ignoreMobileResize, _baseScreenHeight, _baseScreenWidth, _fixIOSBug, _context, _scrollRestoration, _div100vh, _100vh, _isReverted, _clampingMax, _limitCallbacks, _startup = 1, _getTime = Date.now, _time1 = _getTime(), _lastScrollTime = 0, _enabled = 0, _parseClamp = function _parseClamp2(value, type, self) {
  ...
  return (dimensionProperty === "Height" ? _100vh : _win$1["inner" + dimensionProperty]) || _docEl["client" + dimensionProperty] || _body$1["client" + dimensionProperty];
  ...
  return Math.max(0, (s2 = "scroll" + d2) && (a = _getProxyProp(element, s2)) ? a() - _getBoundsFunc(element)()[d] : _isViewport2(element) ? (_docEl[s2] || _body$1[s2]) - _getViewportDimension(d2) : element[s2] - element["offset" + d2]);
  ...
  if (marker) {
    ...
    _positionMarker(marker, position, direction, isStart && position > 20 || !isStart && (useFixedPosition ? Math.max(_body$1[p1], _docEl[p1]) : marker.parentNode[p1]) <= position + 1);
    if (useFixedPosition) {
...
var ScrollTrigger = /* @__PURE__ */ (function() {
  ...
  _proto.init = function init5(vars, animation) {
    ...
    if (snap3) {
      ...
      "scrollBehavior" in _body$1.style && gsap$1.set(isViewport ? [_body$1, _docEl] : scroller, {
        scrollBehavior: "auto"
      });
      _scrollers.forEach(function(o) {
        return _isFunction2(o) && o.target === (isViewport ? _doc$1.scrollingElement || _docEl : scroller) && (o.smooth = false);
      });
  ...
  ScrollTrigger2.scrollerProxy = function scrollerProxy(target, vars) {
    ...
    if (vars) {
      isViewport ? _proxies.unshift(_win$1, vars, _body$1, vars, _docEl, vars) : _proxies.unshift(t, vars);
    }
  };
...
var _clampScrollAndGetDurationMultiplier = function _clampScrollAndGetDurationMultiplier2(scrollFunc, current, end, max) {
  ...
  target === _docEl && _allowNativePanning2(_body$1, direction);
}, _overflow = {
  auto: 1,
  scroll: 1
...
const FONT_DISPLAY$1 = "'Playfair Display', Georgia, serif";
const FONT_MONO$4 = "'JetBrains Mono', 'Fira Code', monospace";
const FONT_BODY$1 = "'Outfit', 'Helvetica Neue', sans-serif";
function EggAnimation() {
  ...
  useEffect(() => {
    ...
    const ctx = gsapWithCSS.context(() => {
      const commits = el.querySelectorAll(".egg-commit");
      const arrows = el.querySelectorAll(".egg-arrow");
      const patternBox = el.querySelector(".egg-pattern-box");
      const matchLines = el.querySelectorAll(".egg-match-line");
      const scoreBar = el.querySelector(".egg-score-fill");
      const scoreNum = el.querySelector(".egg-score-num");
      const verdict = el.querySelector(".egg-verdict");
      ...
      tl.set(commits, { opacity: 0, x: -20 }).set(arrows, { scaleX: 0, transformOrigin: "left center" }).set(patternBox, { opacity: 0, scale: 0.92 }).set(matchLines, { opacity: 0, scaleX: 0, transformOrigin: "left center" }).set(scoreBar, { scaleX: 0, transformOrigin: "left center" }).set(scoreNum, { innerText: "0", opacity: 0 }).set(verdict, { opacity: 0, y: 8 });
      tl.to(commits, {
        opacity: 1,
        x: 0,
        duration: 0.4,
  ...
  return /* @__PURE__ */ jsxs("div", { ref: container, className: "egg-anim-box", style: styles.animBox, children: [
    /* @__PURE__ */ jsxs("div", { className: "egg-commits-col", style: { display: "flex", flexDirection: "column", gap: 6, minWidth: 120 }, children: [
      /* @__PURE__ */ jsx("div", { style: styles.miniLabel, children: "Git History" }),
      [
      ...
      ].map((c, i) => /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [
        /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsx("span", { style: { color: c.color, fontSize: "0.65rem" }, children: c.status === "merged" ? "✓" : "✗" }),
              /* @__PURE__ */ jsx("span", { style: { fontFamily: "'JetBrains Mono', monospace", fontSize: "0.68rem", color: palette.textMuted }, children: c.hash })
            ]
          }
        ),
        /* @__PURE__ */ jsx(
    ...
    /* @__PURE__ */ jsxs("div", { className: "egg-pattern-box", style: styles.patternBox, children: [
      /* @__PURE__ */ jsx("div", { style: { fontSize: "0.6rem", color: palette.accent, letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: 8 }, children: "Team Pattern Model" }),
      /* @__PURE__ */ jsx("div", { style: { display: "flex", flexDirection: "column", gap: 4 }, children: ["naming conventions", "error handling", "test coverage"].map((label, i) => /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: 6 }, children: [
        /* @__PURE__ */ jsx(
          "div",
          {
        ...
        /* @__PURE__ */ jsx("span", { style: { fontSize: "0.62rem", color: palette.textMuted, fontFamily: "'JetBrains Mono', monospace" }, children: label })
      ] }, i)) })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "egg-score-col", style: { display: "flex", flexDirection: "column", gap: 6, minWidth: 90, alignItems: "flex-end" }, children: [
      /* @__PURE__ */ jsx("div", { style: styles.miniLabel, children: "EGG Score" }),
      /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "baseline", gap: 3 }, children: [
        /* @__PURE__ */ jsx("span", { className: "egg-score-num", style: { fontFamily: "'JetBrains Mono', monospace", fontSize: "1.6rem", fontWeight: 700, color: palette.accent, lineHeight: 1 }, children: "0" }),
        /* @__PURE__ */ jsx("span", { style: { fontSize: "0.65rem", color: palette.textMuted }, children: "/100" })
      ] }),
      /* @__PURE__ */ jsx("div", { style: { width: "100%", height: 3, background: palette.border, borderRadius: 2, overflow: "hidden" }, children: /* @__PURE__ */ jsx("div", { className: "egg-score-fill", style: { width: "94%", height: "100%", background: `linear-gradient(to right, ${palette.accent}, ${palette.warn})`, borderRadius: 2 } }) }),
      /* @__PURE__ */ jsx("div", { className: "egg-verdict", style: { fontSize: "0.58rem", color: palette.accent, fontFamily: "'JetBrains Mono', monospace", letterSpacing: "0.08em", background: palette.accentDim, padding: "2px 8px", borderRadius: 4, border: `1px solid var(--accent-20)` }, children: "MATCHES TEAM STYLE" })
    ] })
  ] });
}
function IodAnimation() {
  ...
  useEffect(() => {
    ...
    if (!el) return;
    const ctx = gsapWithCSS.context(() => {
      const saidLines = el.querySelectorAll(".iod-said-line");
      const didLines = el.querySelectorAll(".iod-did-line");
      const connector = el.querySelector(".iod-connector");
      const divergeItems = el.querySelectorAll(".iod-diverge-item");
      const scoreBadge = el.querySelector(".iod-score-badge");
      const scanLine = el.querySelector(".iod-scan-line");
      const tl = gsapWithCSS.timeline({
        scrollTrigger: {
          trigger: el,
          start: "top 78%",
      ...
      tl.set(saidLines, { opacity: 0, x: -12 }).set(didLines, { opacity: 0, x: 12 }).set(connector, { scaleY: 0, transformOrigin: "top center" }).set(divergeItems, { opacity: 0, scale: 0.8 }).set(scoreBadge, { opacity: 0, scale: 0.8 }).set(scanLine, { top: "0%", opacity: 0 });
      tl.to(saidLines, {
        opacity: 1,
        x: 0,
        duration: 0.35,
  ...
  return /* @__PURE__ */ jsxs("div", { ref: container, className: "iod-anim-box", style: styles.animBox, children: [
    /* @__PURE__ */ jsxs("div", { style: { flex: 1, minWidth: 0 }, children: [
      /* @__PURE__ */ jsx("div", { style: { ...styles.miniLabel, color: palette.accent }, children: "AI Reasoning" }),
      /* @__PURE__ */ jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 4, position: "relative" }, children: [
        /* @__PURE__ */ jsx(
          "div",
          {
        ...
        [
          ...
          '"no side effects"',
          '"CSS-only change"'
        ].map((line, i) => /* @__PURE__ */ jsxs("div", { className: "iod-said-line", style: styles.codeLine, children: [
          /* @__PURE__ */ jsx("span", { style: { color: palette.accent, opacity: 0.5, marginRight: 6, fontSize: "0.58rem" }, children: i + 1 }),
          /* @__PURE__ */ jsx("span", { style: { color: palette.text, fontSize: "0.66rem", fontFamily: "'JetBrains Mono', monospace" }, children: line })
        ] }, i))
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "iod-connector-col", style: { display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", width: 32, gap: 4, position: "relative" }, children: [
      /* @__PURE__ */ jsx(
        "div",
        {
      ...
      [palette.accent, palette.warn].map((c, i) => /* @__PURE__ */ jsx(
        "div",
        {
    ...
    /* @__PURE__ */ jsxs("div", { style: { flex: 1, minWidth: 0 }, children: [
      /* @__PURE__ */ jsx("div", { style: { ...styles.miniLabel, color: palette.warn }, children: "Actual Diff" }),
      ...
      ].map((line, i) => /* @__PURE__ */ jsx("div", { className: "iod-did-line", style: { ...styles.codeLine, borderColor: i > 0 ? "rgba(245,122,122,0.2)" : "var(--accent-15)" }, children: /* @__PURE__ */ jsx("span", { style: { color: line.color, fontSize: "0.66rem", fontFamily: "'JetBrains Mono', monospace" }, children: line.text }) }, i)) })
    ] }),
    /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsx("span", { style: { fontSize: "0.58rem", color: palette.red, fontFamily: "'JetBrains Mono', monospace", letterSpacing: "0.06em" }, children: "IOD: DIVERGENCE DETECTED" }),
          /* @__PURE__ */ jsx("span", { style: { fontSize: "0.72rem", fontWeight: 700, color: palette.red }, children: "⚠" })
        ]
      }
    )
  ] });
...
function Scoring() {
  ...
  useEffect(() => {
    ...
    if (!el) return;
    const ctx = gsapWithCSS.context(() => {
      const header = el.querySelector(".scoring-header");
      const cards = el.querySelectorAll(".scoring-card");
  ...
  return /* @__PURE__ */ jsxs("section", { ref: sectionRef, style: { maxWidth: 1440, margin: "0 auto", padding: "0 32px" }, id: "scoring", children: [
    /* @__PURE__ */ jsxs("div", { className: "scoring-header", children: [
      /* @__PURE__ */ jsx("div", { style: {
        fontSize: "0.72rem",
        fontWeight: 700,
        letterSpacing: "0.12em",
        ...
        color: palette.accent,
        marginBottom: 14
      }, children: "Scoring Engine" }),
      /* @__PURE__ */ jsx("h2", { style: {
        fontFamily: FONT_DISPLAY$1,
        ...
        marginBottom: 12,
        color: palette.text
      }, children: "Two signals. Zero blind spots." }),
      /* @__PURE__ */ jsx("p", { style: {
        fontSize: "1.05rem",
        color: palette.textMuted,
        maxWidth: 620,
        lineHeight: 1.7,
        fontFamily: FONT_BODY$1
      }, children: "Pattern-match against your team's actual review history. Then verify if the AI did what it claimed." })
    ] }),
    /* @__PURE__ */ jsxs("div", { style: styles.grid, children: [
      /* @__PURE__ */ jsxs("div", { className: "scoring-card", style: styles.card, children: [
        /* @__PURE__ */ jsx("div", { style: { position: "absolute", top: 0, left: 0, right: 0, height: 2, background: `linear-gradient(to right, ${palette.accent}, transparent)` } }),
        /* @__PURE__ */ jsxs("div", { style: { textAlign: "center", marginBottom: 16 }, children: [
          /* @__PURE__ */ jsx("h3", { style: { ...styles.cardTitle, fontSize: "1.8rem", marginBottom: 8 }, children: "Evolutionary Grading" }),
          /* @__PURE__ */ jsx("span", { style: styles.cardTag, children: "EGG" })
        ] }),
        /* @__PURE__ */ jsxs("p", { style: styles.cardDesc, children: [
          "Learns from your team's merged PRs and reverts. Scores AI output against",
          " ",
          /* @__PURE__ */ jsx("em", { style: { color: palette.accent }, children: "your actual review patterns" }),
          ", not a generic rubric."
        ] }),
        /* @__PURE__ */ jsx(EggAnimation, {}),
        /* @__PURE__ */ jsxs("div", { style: styles.cardFooter, children: [
          /* @__PURE__ */ jsx("span", { style: footerDot(palette.accent) }),
          "Code that matches team style scores high. Foreign patterns get flagged."
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "scoring-card", style: styles.card, children: [
        /* @__PURE__ */ jsx("div", { style: { position: "absolute", top: 0, left: 0, right: 0, height: 2, background: `linear-gradient(to right, ${palette.warn}, transparent)` } }),
        /* @__PURE__ */ jsxs("div", { style: { textAlign: "center", marginBottom: 16 }, children: [
          /* @__PURE__ */ jsx("h3", { style: { ...styles.cardTitle, fontSize: "1.8rem", marginBottom: 8 }, children: "Intent-Outcome Divergence" }),
          /* @__PURE__ */ jsx("span", { style: { ...styles.cardTag, color: palette.warn, background: "rgba(245,200,122,0.08)", borderColor: "rgba(245,200,122,0.2)" }, children: "IOD" })
        ] }),
        /* @__PURE__ */ jsxs("p", { style: styles.cardDesc, children: [
          "Diffs the AI's stated reasoning against the actual code change. If the",
          " ",
          /* @__PURE__ */ jsx("em", { style: { color: palette.warn }, children: "intent doesn't match the outcome" }),
          ", IOD catches it."
        ] }),
        /* @__PURE__ */ jsx(IodAnimation, {}),
        /* @__PURE__ */ jsxs("div", { style: styles.cardFooter, children: [
          /* @__PURE__ */ jsx("span", { style: footerDot(palette.warn) }),
 ...
 * @author: Jack Doyle, jack@greensock.com
*/
var _svgPathExp = /[achlmqstvz]|(-?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/ig, _numbersExp = /(?:(-)?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/ig, _scientific = /[\+\-]?\d*\.?\d+e[\+\-]?\d+/ig, _selectorExp = /(^[#\.][a-z]|[a-y][a-z])/i, _DEG2RAD$1 = Math.PI / 180, _RAD2DEG = 180 / Math.PI, _sin = Math.sin, _cos = Math.cos, _abs = Math.abs, _sqrt = Math.sqrt, _atan2 = Math.atan2, _largeNum = 1e8, _isString3 = function _isString4(value) {
  return typeof value === "string";
...
function sliceRawPath(rawPath, start, end) {
  ...
  var wrap3 = end > 1, s2 = getProgressData(path, start, _temp, true), e = getProgressData(path, end, _temp2), eSeg = e.segment, sSeg = s2.segment, eSegIndex = e.segIndex, sSegIndex = s2.segIndex, ei = e.i, si = s2.i, sameSegment = sSegIndex === eSegIndex, sameBezier = ei === si && sameSegment, wrapsBehind, sShift, eShift, i, copy, totalSegments, l, j;
  if (wrap3 || loops) {
    wrapsBehind = eSegIndex < sSegIndex || sameSegment && ei < si || sameBezier && e.t < s2.t;
    ...
    if (start !== end) {
      sShift = subdivideSegment(sSeg, si, sameBezier ? s2.t / e.t : s2.t);
 ...
 * @author: Jack Doyle, jack@greensock.com
*/
var _xProps = "x,translateX,left,marginLeft,xPercent".split(","), _yProps = "y,translateY,top,marginTop,yPercent".split(","), _DEG2RAD = Math.PI / 180, gsap, PropTween, _getUnit, _toArray, _getStyleSaver2, _reverting, _getGSAP3 = function _getGSAP4() {
...
_getGSAP3() && gsap.registerPlugin(MotionPathPlugin);
gsapWithCSS.registerPlugin(ScrollTrigger, MotionPathPlugin);
const FONT_DISPLAY = "'Playfair Display', Georgia, serif";
const FONT_MONO$3 = "'JetBrains Mono', 'Fira Code', monospace";
const FONT_BODY = "'Outfit', 'Helvetica Neue', sans-serif";
const INFINITY_PATH = "M 600 260 C 600 80, 200 80, 200 260 C 200 440, 600 440, 600 260 C 600 80, 1000 80, 1000 260 C 1000 440, 600 440, 600 260";
const loopLabels = [
...
const VERTICAL_INFINITY_PATH = "M 260 600 C 80 600, 80 200, 260 200 C 440 200, 440 600, 260 600 C 80 600, 80 1000, 260 1000 C 440 1000, 440 600, 260 600";
...
function Lifecycle() {
  ...
  const svgVertRef = useRef(null);
  useEffect(() => {
    const section = sectionRef.current;
    const svg = svgRef.current;
    if (!section || !svg) return;
    const ctx = gsapWithCSS.context(() => {
      const header = section.querySelector(".lc-header");
      if (header) {
        gsapWithCSS.from(header, {
          opacity: 0,
          y: 36,
      ...
      const card = section.querySelector(".lc-card");
      if (card) {
        gsapWithCSS.from(card, {
          opacity: 0,
          y: 50,
      ...
      const infinityPath = svg.querySelector("#infinity-stroke");
      if (infinityPath) {
        const length = infinityPath.getTotalLength();
        gsapWithCSS.set(infinityPath, { strokeDasharray: length, strokeDashoffset: length });
        gsapWithCSS.to(infinityPath, {
          strokeDashoffset: 0,
          duration: 2.5,
          ease: "power2.inOut",
      ...
      const labels = svg.querySelectorAll(".loop-label");
      gsapWithCSS.set(labels, { opacity: 0, y: 12 });
      gsapWithCSS.to(labels, {
        opacity: 1,
        y: 0,
        duration: 0.45,
        stagger: 0.18,
      ...
      const badges = svg.querySelectorAll(".center-badge");
      gsapWithCSS.set(badges, { opacity: 0, scale: 0.85 });
      gsapWithCSS.to(badges, {
        opacity: 1,
        scale: 1,
        duration: 0.5,
        stagger: 0.2,
      ...
      const bottomCards = section.querySelectorAll(".lc-bottom-card");
      gsapWithCSS.set(bottomCards, { opacity: 0, y: 30 });
      gsapWithCSS.to(bottomCards, {
        opacity: 1,
        y: 0,
        duration: 0.55,
        stagger: 0.15,
      ...
      if (vSvg) {
        const vPath = vSvg.querySelector("#v-infinity-stroke");
        if (vPath) {
          const len = vPath.getTotalLength();
          gsapWithCSS.set(vPath, { strokeDasharray: len, strokeDashoffset: len });
          gsapWithCSS.to(vPath, {
            strokeDashoffset: 0,
            duration: 2.5,
            ease: "power2.inOut",
        ...
        const vLabels = vSvg.querySelectorAll(".loop-label-v");
        gsapWithCSS.set(vLabels, { opacity: 0 });
        gsapWithCSS.to(vLabels, {
          opacity: 1,
          duration: 0.45,
          stagger: 0.18,
          ease: "power2.out",
        ...
        const vBadges = vSvg.querySelectorAll(".center-badge-v");
        gsapWithCSS.set(vBadges, { opacity: 0, scale: 0.85 });
        gsapWithCSS.to(vBadges, {
          opacity: 1,
          scale: 1,
          duration: 0.5,
          stagger: 0.2,
        ...
        const vDots = vSvg.querySelectorAll(".flow-dot-v");
        vDots.forEach((dot, i) => {
          gsapWithCSS.to(dot, {
            motionPath: {
  ...
  return /* @__PURE__ */ jsxs("section", { ref: sectionRef, style: { maxWidth: 1440, margin: "0 auto", padding: "0 32px" }, id: "lifecycle", children: [
    /* @__PURE__ */ jsxs("div", { className: "lc-header", children: [
      /* @__PURE__ */ jsx("div", { style: s.tag, children: "Platform Lifecycle" }),
      /* @__PURE__ */ jsxs("h2", { style: s.h2, children: [
        "From submission to production.",
        " ",
        /* @__PURE__ */ jsx("span", { style: { color: palette.textMuted, fontStyle: "italic" }, children: "One loop." })
      ] }),
      /* @__PURE__ */ jsx("p", { style: s.sub, children: "Developers submit. Observal evaluates, documents, and publishes. Agents deploy and get scored in production, continuously." })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "lc-card", style: { ...s.card, background: "#0e1016", border: "1px solid #1e2130" }, children: [
      /* @__PURE__ */ jsx(
        "div",
        {
          style: {
        ...
        "svg",
        {
          ...
          children: [
            /* @__PURE__ */ jsxs("defs", { children: [
              ...
              /* @__PURE__ */ jsxs("filter", { id: "glowSoft", x: "-30%", y: "-30%", width: "160%", height: "160%", children: [
              ...
              /* @__PURE__ */ jsxs("linearGradient", { id: "pathGrad", x1: "0%", y1: "0%", x2: "100%", y2: "0%", children: [
                /* @__PURE__ */ jsx("stop", { offset: "0%", stopColor: palette.accent }),
                /* @__PURE__ */ jsx("stop", { offset: "50%", stopColor: palette.textMuted }),
                /* @__PURE__ */ jsx("stop", { offset: "100%", stopColor: palette.warn })
              ] })
            ] }),
            /* @__PURE__ */ jsx("ellipse", { cx: "300", cy: "260", rx: "220", ry: "180", fill: palette.accent, opacity: "0.02", filter: "url(#glowSoft)" }),
            /* @__PURE__ */ jsx("ellipse", { cx: "900", cy: "260", rx: "220", ry: "180", fill: palette.warn, opacity: "0.02", filter: "url(#glowSoft)" }),
            /* @__PURE__ */ jsx("path", { id: "infinity-motion", d: INFINITY_PATH, stroke: "none", fill: "none" }),
            /* @__PURE__ */ jsx(
              "path",
              {
                id: "infinity-stroke",
            ...
            /* @__PURE__ */ jsxs("g", { className: "center-badge", children: [
              /* @__PURE__ */ jsx("rect", { x: "220", y: "236", width: "160", height: "48", rx: "10", fill: "#13151c", stroke: palette.accent, strokeWidth: "1", opacity: "0.95" }),
              /* @__PURE__ */ jsx("text", { x: "300", y: "256", textAnchor: "middle", fill: palette.accent, fontSize: "11", fontFamily: "'Outfit', sans-serif", fontWeight: "700", letterSpacing: "0.1em", children: "MCP REGISTRY" }),
              /* @__PURE__ */ jsx("text", { x: "300", y: "273", textAnchor: "middle", fill: "#8b8fa6", fontSize: "9", fontFamily: "'JetBrains Mono', monospace", children: "discover · install · monitor" })
            ] }),
            /* @__PURE__ */ jsxs("g", { className: "center-badge", children: [
              /* @__PURE__ */ jsx("rect", { x: "820", y: "236", width: "160", height: "48", rx: "10", fill: "#13151c", stroke: palette.warn, strokeWidth: "1", opacity: "0.95" }),
              /* @__PURE__ */ jsx("text", { x: "900", y: "256", textAnchor: "middle", fill: palette.warn, fontSize: "11", fontFamily: "'Outfit', sans-serif", fontWeight: "700", letterSpacing: "0.1em", children: "AGENT REGISTRY" }),
              /* @__PURE__ */ jsx("text", { x: "900", y: "273", textAnchor: "middle", fill: "#8b8fa6", fontSize: "9", fontFamily: "'JetBrains Mono', monospace", children: "deploy · evaluate · score" })
            ] }),
            /* @__PURE__ */ jsxs("g", { className: "center-badge", children: [
              /* @__PURE__ */ jsx("rect", { x: "548", y: "240", width: "104", height: "40", rx: "8", fill: "#0e1016", stroke: "#2c3050", strokeWidth: "1" }),
              /* @__PURE__ */ jsx("text", { x: "600", y: "257", textAnchor: "middle", fill: "#e4e5eb", fontSize: "9", fontFamily: "'Outfit', sans-serif", fontWeight: "600", letterSpacing: "0.04em", children: "OBSERVAL" }),
              /* @__PURE__ */ jsx("text", { x: "600", y: "270", textAnchor: "middle", fill: "#8b8fa6", fontSize: "8", fontFamily: "'JetBrains Mono', monospace", children: "orchestrator" })
            ] }),
            loopLabels.map((l, i) => {
              const isLeft = l.side === "left";
              const color = isLeft ? palette.accent : palette.warn;
              return /* @__PURE__ */ jsx("g", { className: "loop-label", children: /* @__PURE__ */ jsx(
                "text",
                {
                  x: l.x,
                  y: l.y,
      ...
      /* @__PURE__ */ jsxs(
        "svg",
        {
          ...
          children: [
            /* @__PURE__ */ jsxs("defs", { children: [
              /* @__PURE__ */ jsxs("filter", { id: "glowV", x: "-20%", y: "-20%", width: "140%", height: "140%", children: [
                /* @__PURE__ */ jsx("feGaussianBlur", { stdDeviation: "6", result: "blur" }),
                /* @__PURE__ */ jsxs("feMerge", { children: [
                  /* @__PURE__ */ jsx("feMergeNode", { in: "blur" }),
                  /* @__PURE__ */ jsx("feMergeNode", { in: "SourceGraphic" })
              ...
              /* @__PURE__ */ jsxs("filter", { id: "glowSoftV", x: "-30%", y: "-30%", width: "160%", height: "160%", children: [
                /* @__PURE__ */ jsx("feGaussianBlur", { stdDeviation: "12", result: "blur" }),
                /* @__PURE__ */ jsxs("feMerge", { children: [
                  /* @__PURE__ */ jsx("feMergeNode", { in: "blur" }),
                  /* @__PURE__ */ jsx("feMergeNode", { in: "SourceGraphic" })
              ...
              /* @__PURE__ */ jsxs("linearGradient", { id: "pathGradV", x1: "50%", y1: "0%", x2: "50%", y2: "100%", children: [
                /* @__PURE__ */ jsx("stop", { offset: "0%", stopColor: palette.accent }),
                /* @__PURE__ */ jsx("stop", { offset: "50%", stopColor: palette.textMuted }),
                /* @__PURE__ */ jsx("stop", { offset: "100%", stopColor: palette.warn })
              ] })
            ] }),
            /* @__PURE__ */ jsx("ellipse", { cx: "260", cy: "300", rx: "180", ry: "220", fill: palette.accent, opacity: "0.02", filter: "url(#glowSoftV)" }),
            /* @__PURE__ */ jsx("ellipse", { cx: "260", cy: "900", rx: "180", ry: "220", fill: palette.warn, opacity: "0.02", filter: "url(#glowSoftV)" }),
            /* @__PURE__ */ jsx("path", { id: "v-infinity-motion", d: VERTICAL_INFINITY_PATH, stroke: "none", fill: "none" }),
            /* @__PURE__ */ jsx(
              "path",
              {
            ...
            /* @__PURE__ */ jsxs("g", { className: "center-badge-v", children: [
              /* @__PURE__ */ jsx("rect", { x: "160", y: "276", width: "200", height: "48", rx: "10", fill: "#13151c", stroke: palette.accent, strokeWidth: "1", opacity: "0.95" }),
              /* @__PURE__ */ jsx("text", { x: "260", y: "296", textAnchor: "middle", fill: palette.accent, fontSize: "14", fontFamily: "'Outfit', sans-serif", fontWeight: "700", letterSpacing: "0.1em", children: "MCP REGISTRY" }),
              /* @__PURE__ */ jsx("text", { x: "260", y: "314", textAnchor: "middle", fill: "#8b8fa6", fontSize: "11", fontFamily: "'JetBrains Mono', monospace", children: "discover · install · monitor" })
            ] }),
            /* @__PURE__ */ jsxs("g", { className: "center-badge-v", children: [
              /* @__PURE__ */ jsx("rect", { x: "150", y: "876", width: "220", height: "48", rx: "10", fill: "#13151c", stroke: palette.warn, strokeWidth: "1", opacity: "0.95" }),
              /* @__PURE__ */ jsx("text", { x: "260", y: "896", textAnchor: "middle", fill: palette.warn, fontSize: "14", fontFamily: "'Outfit', sans-serif", fontWeight: "700", letterSpacing: "0.1em", children: "AGENT REGISTRY" }),
              /* @__PURE__ */ jsx("text", { x: "260", y: "914", textAnchor: "middle", fill: "#8b8fa6", fontSize: "11", fontFamily: "'JetBrains Mono', monospace", children: "deploy · evaluate · score" })
            ] }),
            /* @__PURE__ */ jsxs("g", { className: "center-badge-v", children: [
              /* @__PURE__ */ jsx("rect", { x: "195", y: "576", width: "130", height: "48", rx: "8", fill: "#0e1016", stroke: "#2c3050", strokeWidth: "1" }),
              /* @__PURE__ */ jsx("text", { x: "260", y: "596", textAnchor: "middle", fill: "#e4e5eb", fontSize: "12", fontFamily: "'Outfit', sans-serif", fontWeight: "600", letterSpacing: "0.04em", children: "OBSERVAL" }),
              /* @__PURE__ */ jsx("text", { x: "260", y: "612", textAnchor: "middle", fill: "#8b8fa6", fontSize: "10", fontFamily: "'JetBrains Mono', monospace", children: "orchestrator" })
            ] }),
            verticalLabels.map((l, i) => {
              const color = l.side === "top" ? palette.accent : palette.warn;
              return /* @__PURE__ */ jsx("g", { className: "loop-label-v", children: /* @__PURE__ */ jsx(
                "text",
                {
                  x: l.x,
                  y: l.y,
      ...
      /* @__PURE__ */ jsxs("div", { style: s.legend, children: [
        /* @__PURE__ */ jsxs("div", { style: s.legendItem, children: [
          /* @__PURE__ */ jsx("div", { style: { ...s.legendDot, background: palette.accent, boxShadow: `0 0 8px ${palette.accent}` } }),
          /* @__PURE__ */ jsx("span", { style: s.legendText, children: "MCP Registry Loop" })
        ] }),
        /* @__PURE__ */ jsx("div", { style: { width: 1, height: 16, background: palette.border } }),
        /* @__PURE__ */ jsxs("div", { style: s.legendItem, children: [
          /* @__PURE__ */ jsx("div", { style: { ...s.legendDot, background: palette.warn, boxShadow: `0 0 8px ${palette.warn}` } }),
          /* @__PURE__ */ jsx("span", { style: s.legendText, children: "Agent Registry Loop" })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { style: s.bottomGrid, children: [
      /* @__PURE__ */ jsxs("div", { className: "lc-bottom-card", style: s.bottomCard, children: [
        /* @__PURE__ */ jsx("div", { style: { ...s.bottomStripe, background: palette.accent } }),
        /* @__PURE__ */ jsx("div", { style: s.bottomHeader, children: /* @__PURE__ */ jsx("span", { style: s.bottomTitle, children: "MCP Registry" }) }),
        /* @__PURE__ */ jsxs("div", { style: s.bottomBody, children: [
          /* @__PURE__ */ jsxs("div", { style: s.step, children: [
            /* @__PURE__ */ jsx("span", { style: { ...s.stepNum, color: palette.accent }, children: "01" }),
            /* @__PURE__ */ jsxs("span", { style: s.stepText, children: [
              "Submit via ",
              /* @__PURE__ */ jsx("code", { style: s.code, children: "/submit <GIT_URL>" })
            ] })
          ] }),
          /* @__PURE__ */ jsxs("div", { style: s.step, children: [
            /* @__PURE__ */ jsx("span", { style: { ...s.stepNum, color: palette.accent }, children: "02" }),
            /* @__PURE__ */ jsx("span", { style: s.stepText, children: "Auto-evaluate: security, schema validation, docs check" })
          ] }),
          /* @__PURE__ */ jsxs("div", { style: s.step, children: [
            /* @__PURE__ */ jsx("span", { style: { ...s.stepNum, color: palette.accent }, children: "03" }),
            /* @__PURE__ */ jsx("span", { style: s.stepText, children: "Published with docs, config file download, and setup steps" })
          ] }),
          /* @__PURE__ */ jsxs("div", { style: s.step, children: [
            /* @__PURE__ */ jsx("span", { style: { ...s.stepNum, color: palette.accent }, children: "04" }),
            /* @__PURE__ */ jsx("span", { style: s.stepText, children: "Track downloads & tool calls per MCP in production" })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "lc-bottom-card", style: s.bottomCard, children: [
        /* @__PURE__ */ jsx("div", { style: { ...s.bottomStripe, background: palette.warn } }),
        /* @__PURE__ */ jsx("div", { style: s.bottomHeader, children: /* @__PURE__ */ jsx("span", { style: s.bottomTitle, children: "Agent Registry" }) }),
        /* @__PURE__ */ jsxs("div", { style: s.bottomBody, children: [
          /* @__PURE__ */ jsxs("div", { style: s.step, children: [
            /* @__PURE__ */ jsx("span", { style: { ...s.stepNum, color: palette.warn }, children: "01" }),
            /* @__PURE__ */ jsxs("span", { style: s.stepText, children: [
              "Submit via ",
              /* @__PURE__ */ jsx("code", { style: s.code, children: "/submit <GIT_URL>" })
            ] })
          ...
          /* @__PURE__ */ jsxs("div", { style: s.step, children: [
            /* @__PURE__ */ jsx("span", { style: { ...s.stepNum, color: palette.warn }, children: "02" }),
            /* @__PURE__ */ jsx("span", { style: s.stepText, children: "Auto-evaluate agent definition: Prompt + MCPs + Model" })
          ] }),
          /* @__PURE__ */ jsxs("div", { style: s.step, children: [
            /* @__PURE__ */ jsx("span", { style: { ...s.stepNum, color: palette.warn }, children: "03" }),
            /* @__PURE__ */ jsx("span", { style: s.stepText, children: "Document purpose, capabilities, and dependencies" })
          ] }),
          /* @__PURE__ */ jsxs("div", { style: s.step, children: [
            /* @__PURE__ */ jsx("span", { style: { ...s.stepNum, color: palette.warn }, children: "04" }),
            /* @__PURE__ */ jsx("span", { style: s.stepText, children: "SLM Judge scores production runs: acceptance, tool calls, CoT quality" })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "lc-bottom-card", style: { ...s.bottomCard, borderColor: palette.borderHi }, children: [
        /* @__PURE__ */ jsx("div", { style: { ...s.bottomStripe, background: `linear-gradient(to right, ${palette.accent}, ${palette.warn})` } }),
        /* @__PURE__ */ jsx("div", { style: s.bottomHeader, children: /* @__PURE__ */ jsx("span", { style: s.bottomTitle, children: "Agent = Prompt + MCPs + Model" }) }),
        /* @__PURE__ */ jsxs("div", { style: s.bottomBody, children: [
          /* @__PURE__ */ jsxs("div", { style: s.compositionRow, children: [
            /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: 10 }, children: [
              /* @__PURE__ */ jsxs("div", { style: s.compChip, children: [
                /* @__PURE__ */ jsx("span", { style: { color: palette.accent, fontSize: "0.9rem" }, children: "Prompt" }),
                /* @__PURE__ */ jsx("span", { style: { color: palette.textMuted, fontSize: "0.78rem" }, children: "system instructions" })
              ] }),
              /* @__PURE__ */ jsx("span", { style: { color: palette.border, fontSize: "1.4rem", lineHeight: 1 }, children: "+" })
            ] }),
            /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: 10 }, children: [
              /* @__PURE__ */ jsxs("div", { style: s.compChip, children: [
                /* @__PURE__ */ jsx("span", { style: { color: palette.warn, fontSize: "0.9rem" }, children: "MCPs" }),
                /* @__PURE__ */ jsx("span", { style: { color: palette.textMuted, fontSize: "0.78rem" }, children: "tool servers" })
              ] }),
              /* @__PURE__ */ jsx("span", { style: { color: palette.border, fontSize: "1.4rem", lineHeight: 1 }, children: "+" })
            ] }),
            /* @__PURE__ */ jsxs("div", { style: s.compChip, children: [
              /* @__PURE__ */ jsx("span", { style: { color: "#82aaff", fontSize: "0.9rem" }, children: "Model" }),
              /* @__PURE__ */ jsx("span", { style: { color: palette.textMuted, fontSize: "0.78rem" }, children: "LLM config" })
            ] })
          ] }),
          /* @__PURE__ */ jsx("div", { style: { fontSize: "0.95rem", color: palette.textMuted, lineHeight: 1.6, marginTop: 12 }, children: "Every agent is a declarative composition. Submit the repo, Observal handles the rest: evaluation, documentation, and production monitoring via SLM-as-a-judge." })
        ] })
      ] })
    ] })
  ] });
...
function Counter({ end, suffix = "", duration = 1800 }) {
  ...
  const [ref2, visible] = useInView(0.3);
  useEffect(() => {
    if (!visible) return;
    let start = 0;
  ...
  return /* @__PURE__ */ jsxs("span", { ref: ref2, children: [
    val,
    suffix
  ] });
}
function Proof() {
  return /* @__PURE__ */ jsxs("section", { style: S.section, id: "proof", children: [
    /* @__PURE__ */ jsxs(Reveal, { children: [
      /* @__PURE__ */ jsx("div", { style: S.sectionTag, children: "The Case for Change" }),
      /* @__PURE__ */ jsxs("h2", { style: S.sectionH2, children: [
        "Standard LLM evaluators are a liability.",
        " ",
        /* @__PURE__ */ jsx("span", { style: { color: palette.textMuted, fontStyle: "italic" }, children: "Here's the data." })
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { style: { ...S.proofGrid, "@media (maxWidth: 768px)": { gridTemplateColumns: "1fr" } }, children: [
      /* @__PURE__ */ jsx(Reveal, { delay: 0.05, children: /* @__PURE__ */ jsxs("div", { style: S.proofProblem, children: [
        /* @__PURE__ */ jsx("div", { style: { ...S.proofTag, color: "#c0392b", fontSize: "0.85rem" }, children: "⚠ The Problem" }),
        /* @__PURE__ */ jsxs("h3", { style: { ...S.proofH3, color: "#1a1a2e", fontSize: "2rem" }, children: [
          /* @__PURE__ */ jsx(Counter, { end: 93, suffix: "%" }),
          " of teams hit eval failures"
        ] }),
        /* @__PURE__ */ jsx("p", { style: { ...S.pillarP, color: "#5c6070", marginBottom: 20, fontSize: "1.05rem" }, children: "Industry data shows the vast majority of engineering teams experience significant consistency problems when relying on standard LLM-powered evaluations. Outputs drift, hallucinations slip through, and confidence erodes." }),
        /* @__PURE__ */ jsxs("div", { style: { background: "#fef2f2", borderRadius: 10, padding: "20px 24px", fontSize: "1.02rem", color: "#c0392b", border: "1px solid #fecaca" }, children: [
          "Elite teams spend ",
          /* @__PURE__ */ jsx("strong", { children: "40%+ of dev cycles" }),
          " hand-tuning evaluation pipelines just to achieve baseline reliability."
        ] })
      ] }) }),
      /* @__PURE__ */ jsx(Reveal, { delay: 0.15, children: /* @__PURE__ */ jsxs("div", { style: { ...S.proofSolution, background: "#f0fdf4", border: "1px solid #bbf7d0" }, children: [
        /* @__PURE__ */ jsx("div", { style: { ...S.proofTag, color: "#16a34a", fontSize: "0.85rem" }, children: "✓ Our Solution" }),
        /* @__PURE__ */ jsx("h3", { style: { ...S.proofH3, color: "#15803d", fontSize: "2rem" }, children: "Multi-judge consensus, productized." }),
        /* @__PURE__ */ jsx("p", { style: { ...S.pillarP, color: "#5c6070", marginBottom: 20, fontSize: "1.05rem" }, children: 'The "Council of Agents" approach takes the multi-judge consensus methodology pioneered by elite AI teams and packages it as a drop-in API. No bespoke infrastructure. No months of fine-tuning.' }),
        /* @__PURE__ */ jsxs("div", { style: { background: "#dcfce7", borderRadius: 10, padding: "20px 24px", fontSize: "1.02rem", color: "#15803d", border: "1px solid #bbf7d0" }, children: [
          "Get ",
          /* @__PURE__ */ jsx("strong", { children: "elite-tier evaluation coverage" }),
          " out of the box. Reclaim that 40% of engineering time."
        ] })
      ] }) })
    ] })
  ] });
}
const FONT_MONO$2 = "'JetBrains Mono', 'Fira Code', monospace";
const snippets = {
  Python: {
    file: "evaluate.py",
...
function highlight(code, styles2) {
  const lines = code.split("\n");
  return lines.map((line, i) => {
    let node;
    if (line.startsWith("//") || line.startsWith("#")) {
      node = /* @__PURE__ */ jsx("span", { style: styles2.cm, children: line });
    } else {
      const parts = [];
      ...
      while ((match = regex.exec(line)) !== null) {
        if (match.index > lastIdx) {
          parts.push(/* @__PURE__ */ jsx("span", { style: styles2.vr, children: line.slice(lastIdx, match.index) }, key++));
        }
        const tok = match[0];
        if (tok.startsWith('"') || tok.startsWith("'")) {
          parts.push(/* @__PURE__ */ jsx("span", { style: styles2.str, children: tok }, key++));
        } else if (tok.startsWith("//") || tok.startsWith("#")) {
          parts.push(/* @__PURE__ */ jsx("span", { style: styles2.cm, children: tok }, key++));
        } else {
          parts.push(/* @__PURE__ */ jsx("span", { style: styles2.kw, children: tok }, key++));
        }
        lastIdx = match.index + tok.length;
      }
      if (lastIdx < line.length) {
        parts.push(/* @__PURE__ */ jsx("span", { style: styles2.vr, children: line.slice(lastIdx) }, key++));
      }
      node = /* @__PURE__ */ jsx(Fragment, { children: parts });
    }
...
function Code({ language = "Python" }) {
  ...
  return /* @__PURE__ */ jsxs("div", { style: S.codeWrap, className: "section-dark", children: [
    /* @__PURE__ */ jsxs("div", { style: S.codeBar, children: [
      /* @__PURE__ */ jsx("div", { style: S.codeDot("#f57a7a") }),
      /* @__PURE__ */ jsx("div", { style: S.codeDot("#f5c87a") }),
      /* @__PURE__ */ jsx("div", { style: S.codeDot(palette.accent) }),
      /* @__PURE__ */ jsx("span", { style: { marginLeft: 12, fontSize: "0.75rem", color: palette.textMuted, fontFamily: FONT_MONO$2 }, children: current.file })
    ] }),
    /* @__PURE__ */ jsx("pre", { style: { ...S.codeBody, textAlign: "left" }, children: /* @__PURE__ */ jsx("code", { children: highlight(current.code, styles2) }) })
  ] });
}
const sdkLanguages = ["Python", "JavaScript", "Go", "Ruby", "Java", "C#", "PHP"];
const FONT_MONO$1 = "'SF Mono', 'SF Mono Regular', Consolas, 'Liberation Mono', Menlo, Courier, monospace";
function Integration() {
  const [activeLang, setActiveLang] = useState("Python");
  return /* @__PURE__ */ jsxs("section", { style: { ...S.section, textAlign: "center" }, id: "integration", children: [
    /* @__PURE__ */ jsxs(Reveal, { children: [
      /* @__PURE__ */ jsx("div", { style: S.sectionTag, children: "Developer Experience" }),
      /* @__PURE__ */ jsx("h2", { style: { ...S.sectionH2, margin: "0 auto 12px" }, children: "Three lines to a Council verdict." }),
      /* @__PURE__ */ jsx("p", { style: { ...S.sectionSub, margin: "0 auto" }, children: "Route any internal AI tool's output through the Council API. Get a multi-agent consensus score, flagged issues, and full reasoning, instantly." })
    ] }),
    /* @__PURE__ */ jsx(Reveal, { delay: 0.1, children: /* @__PURE__ */ jsx(Code, { language: activeLang }) }),
    /* @__PURE__ */ jsx(Reveal, { delay: 0.2, children: /* @__PURE__ */ jsx("div", { style: { display: "flex", justifyContent: "center", gap: "clamp(10px, 3vw, 32px)", marginTop: 36, flexWrap: "wrap" }, children: sdkLanguages.map((lang) => {
...
function VaultRing() {
  ...
  return /* @__PURE__ */ jsxs(
    "svg",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("defs", { children: [
          /* @__PURE__ */ jsxs("radialGradient", { id: "vaultGlow", cx: "50%", cy: "50%", r: "50%", children: [
            /* @__PURE__ */ jsx("stop", { offset: "0%", stopColor: "var(--accent)", stopOpacity: "0.08" }),
            /* @__PURE__ */ jsx("stop", { offset: "100%", stopColor: "var(--accent)", stopOpacity: "0" })
          ] }),
          /* @__PURE__ */ jsxs("filter", { id: "glowFilter", children: [
        ...
        /* @__PURE__ */ jsx("circle", { cx: "200", cy: "200", r: "195", fill: "url(#vaultGlow)" }),
        /* @__PURE__ */ jsx(
          "circle",
          {
            cx: "200",
        ...
        /* @__PURE__ */ jsxs(
          "g",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx("circle", { cx: "200", cy: "202", r: "6", fill: "var(--accent)", opacity: "0.9" }),
              /* @__PURE__ */ jsx("rect", { x: "197.5", y: "207", width: "5", height: "12", rx: "2", fill: "var(--accent)", opacity: "0.9" })
            ]
          }
        ),
        /* @__PURE__ */ jsx(
...
function Privacy() {
  return /* @__PURE__ */ jsxs("section", { style: S.section, id: "privacy", children: [
    /* @__PURE__ */ jsx("style", { children: `
        @keyframes vaultSpin {
      ...
      ` }),
    /* @__PURE__ */ jsxs(Reveal, { children: [
      /* @__PURE__ */ jsx("div", { style: S.sectionTag, children: "Enterprise Privacy & Security" }),
      /* @__PURE__ */ jsx("h2", { style: S.sectionH2, children: "Your code stays yours. Period." }),
      /* @__PURE__ */ jsx("p", { style: S.sectionSub, children: "We evaluate your AI tools. We never train on your data, expose your proprietary logic, or retain your codebase beyond the evaluation window." })
    ] }),
    /* @__PURE__ */ jsxs("div", { style: {
      ...
      /* @__PURE__ */ jsx("div", { style: {
        ...
        alignItems: "center",
        position: "relative"
      }, children: /* @__PURE__ */ jsx(VaultRing, {}) }),
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx(Reveal, { delay: 0.1, children: /* @__PURE__ */ jsxs("div", { style: {
          display: "flex",
          alignItems: "center",
          gap: 10,
          marginBottom: 8,
          ...
          /* @__PURE__ */ jsx("span", { style: {
            ...
            textTransform: "uppercase",
            color: "var(--accent)"
          }, children: "security protocol: all systems nominal" })
        ] }) }),
        /* @__PURE__ */ jsx(
          StatusLine,
          {
        ...
        /* @__PURE__ */ jsx(Reveal, { delay: 0.8, children: /* @__PURE__ */ jsx("p", { style: {
          fontFamily: FONT_MONO,
          fontSize: "0.82rem",
          color: "var(--text-muted)",
          marginTop: 28,
          ...
          letterSpacing: "0.02em",
          opacity: 0.6
        }, children: "All evaluation inputs are processed in isolated, ephemeral environments and purged immediately after scoring. Your proprietary code never leaves your security boundary." }) })
      ] })
    ] })
  ] });
}
...
function Cta() {
  return /* @__PURE__ */ jsx("section", { style: S.section, id: "cta", children: /* @__PURE__ */ jsx(Reveal, { children: /* @__PURE__ */ jsxs("div", { style: S.ctaBox, children: [
    /* @__PURE__ */ jsx("div", { style: { ...S.sectionTag, marginBottom: 20 }, children: "Get Started Free" }),
    /* @__PURE__ */ jsx("h2", { style: { ...S.sectionH2, margin: "0 auto 16px", textAlign: "center", maxWidth: 600 }, children: "Evaluate your first AI tool in under five minutes." }),
    /* @__PURE__ */ jsx("p", { style: { ...S.sectionSub, margin: "0 auto 36px", textAlign: "center" }, children: "No credit card. No fine-tuning. Just plug in your tool's output and let the Council deliver a verdict." }),
    /* @__PURE__ */ jsxs("div", { style: { display: "flex", justifyContent: "center", gap: 16, flexWrap: "wrap" }, children: [
      /* @__PURE__ */ jsx("button", { style: S.btnPrimary, onMouseEnter: handleHoverIn, onMouseLeave: handleHoverOut, children: "Start Free Evaluation →" }),
      /* @__PURE__ */ jsx("button", { style: S.btnGhost, children: "Talk to Sales" })
    ] })
  ] }) }) });
}
function accentVars(r, g, b) {
  const rgb = `${r},${g},${b}`;
  return {
    "--accent": `rgb(${rgb})`,
    "--accent-rgb": rgb,
...
function App() {
  ...
  return /* @__PURE__ */ jsxs("div", { style: S.page, children: [
    /* @__PURE__ */ jsx(Navbar, {}),
    /* @__PURE__ */ jsx("div", { className: "section-dark", style: accentVars(122, 245, 202), children: /* @__PURE__ */ jsx(Hero, {}) }),
    /* @__PURE__ */ jsx("div", { className: "section-dark", style: { ...pad, ...accentVars(100, 215, 175) }, children: /* @__PURE__ */ jsx(Pillars, {}) }),
    /* @__PURE__ */ jsx("div", { className: "section-dark", style: { ...pad, ...accentVars(80, 185, 148) }, children: /* @__PURE__ */ jsx(Scoring, {}) }),
    /* @__PURE__ */ jsx("div", { className: "section-light", style: { ...pad, ...accentVars(62, 158, 122) }, children: /* @__PURE__ */ jsx(Lifecycle, {}) }),
    /* @__PURE__ */ jsx("div", { className: "section-light", style: { ...pad, ...accentVars(50, 190, 120) }, children: /* @__PURE__ */ jsx(Proof, {}) }),
    /* @__PURE__ */ jsx("div", { className: "section-light", style: { ...pad, ...accentVars(34, 105, 76) }, children: /* @__PURE__ */ jsx(Integration, {}) }),
    /* @__PURE__ */ jsx("div", { className: "section-dark", style: { ...pad, ...accentVars(30, 160, 90) }, children: /* @__PURE__ */ jsx(Privacy, {}) }),
    /* @__PURE__ */ jsx("div", { className: "section-dark", style: { ...pad, ...accentVars(40, 180, 100) }, children: /* @__PURE__ */ jsx(Cta, {}) }),
    /* @__PURE__ */ jsx("div", { className: "section-dark", style: accentVars(14, 58, 38), children: /* @__PURE__ */ jsx(Footer, {}) })
  ] });
}
function render4() {
